...
@Component
@Aspect
public class ChapterContextAfterAdvice {


    @Autowired
    private ReadMapper readMapper;

    @Pointcut(value = "execution(* com.yc.novelclient.service.impl..*.getNovelChapterContext(..))")
    public void getChapterContext(){}

    @AfterReturning(pointcut = "getChapterContext()" ,returning = "result")
